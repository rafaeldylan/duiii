...
submitName.addEventListener('click', () => {
  ...
  apologyTitle.textContent = `${nickname}, Im Sorry DUIBUQIIII 🥺💖`;

  apologyText.innerHTML = `I beneran gak bermaksud ga ngabarin u and bikin kamu kesel.<br>Maafin aku, yaaa 😢`;
});
...
yesBtn.addEventListener('click', () => {
  ...
  popupTitle.textContent = `谢谢你，美女, ${nickname} 💕`;
  popupMsg.textContent = `I berusaha ga bikin u badmood again. 🥺✨`;
  generateHearts();
  setTimeout(() => {
